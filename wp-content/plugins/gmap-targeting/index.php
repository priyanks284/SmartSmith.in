...
/*
  ...
  Plugin URI: https://pluginus.net/shop/wordpress-plugins/google-map-targeting/
  Description: Set Google Map everywhere by shortcode on your site simply. One click - one map!
...
class PluginusNet_GMapTargeting {
    ...
    public static function wp_head()
    {
        ...
        $pages = apply_filters('google_map_pages', array());
        if (empty($pages))
        {
            wp_enqueue_script('maps.google.com', 'https://maps.google.com/maps/api/js?sensor=false');
        } else
        {
    ...
    public static function admin_head()
    {
        ...
        if ($show_shortcode):
            ...
            ?>
                ...
                var gmt_lang_popup_title = "<?php _e('Google Map powered by www.pluginus.net', 'gmap-targeting') ?>";
                var gmt_lang_made_by = "<?php _e('Google Map powered by www.pluginus.net', 'gmap-targeting') ?>";
    ...
    {
        //https://codecanyon.net/user/realmag777/portfolio?ref=realmag777
    }
...
class PluginusNet_GmapTargetingWidget extends WP_Widget {
    ...
    {
        parent::__construct(__CLASS__, __('Google Map Widget', 'gmap-targeting'), array(
            'classname' => __CLASS__,
            'description' => __('Google Map powered by www.pluginus.net', 'gmap-targeting')
                )
        );
    }
...
add_action('widgets_init', array('PluginusNet_GMapTargeting', 'widgets_init'));
